...
```
./ngrok http --domain=mesh.ngrok.app 9001
```
8. 執行 步驟 7 後，ngrok 會產生一個 HTTPS 的 URL：`https://mesh.ngrok.app`
9. ingame 的 URL：https://mesh.ngrok.app/frontend?backend=mesh.ngrok.app
10. PickBan 的 URL：https://mesh.ngrok.app/?backend=ws://mesh.ngrok.app/api
